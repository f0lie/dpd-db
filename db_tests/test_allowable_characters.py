...
class AllowableCharacters:
    ...
    source_allowed = english_capitals + source + digits + space + fullstop + dash
    sutta_allowed = (
        pali_alphabet
        + digits
        + space
    ...
    sbs_category_allowed = english_alphabet + digits
    ...
    sbs_chant_english_allowed = (
        pali_alphabet + english_alphabet + english_capitals + space + apostrophe + dash
    )
