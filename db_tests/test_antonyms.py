                ...
                for r in results:
                    ...
                    for w2_antonym in w2_antonyms:
                        if r.lemma_clean == w1_antonym:
                            ...
                            if g.w1.lemma_clean == w2_antonym and r.pos == g.w1.pos:
                            ...
                            elif g.w1.lemma_clean == w2_antonym and r.pos != g.w1.pos:
                                # check if w2 not already in exceptions
                                if g.w2.id not in g.antonym_dict.get("exceptions").get(
                                    str(g.w1.id), {}
                                ):
                                    print()
                                    print("[red]pos does not match")
                                    print(
                                        f"[green]{'lemma_1':<30}{'pos':10}{'antonym':<20}meaning"
                                    )
                                    print(
                                        f"{g.w1.lemma_1:<30}{g.w1.pos:10}{g.w1.antonym:<20}{g.w1.meaning_1}"
                                    )
                                    print(
                                        f"{r.lemma_1:<30}[red]{r.pos:<10}[/red]{r.antonym:<20}{r.meaning_1}"
                                    )
                            ...
                            # antonym does not match, pos does
                                ...
                                not g.w1.lemma_clean == w2_antonym and r.pos == g.w1.pos
                            ):
                                print()
                                ...
                                print(
                                    f"{r.lemma_1:<30}{r.pos:<10}[red]{r.antonym:<20}[/red]{r.meaning_1}"
                                )
                                ...
                                if g.w2.id not in g.antonym_dict.get("exceptions").get(
                                    ...
                                    if "," not in g.w2.antonym:
                                        ...
                                        print()
                                        print(
                                            "[red]!!! gotta deal with multiple antonyms !!!"
                                        )
                                        print()

                            # w2 has no antonym
                            elif not r.antonym and r.pos == g.w1.pos:
                                print()
                                ...
                                print(
                                    f"{r.lemma_1:<30}{r.pos:10}[red]None{r.antonym:<20}[/red]{r.meaning_1}"
                                )
                                update_w2(g)
                                no_results = False
...
def no_other_results(g):
    ...
    for r in g.results:
        if r.lemma_clean == g.w1_orig_antonym and r.pos == g.w1.pos:
            return False
    return True
...
def update_w2(g):
    print()
    print(
        f"[cyan]u [green] update w1 [white]{g.w1.lemma_1}[/white] antonym [white]{g.w1.antonym}"
    )
    print(
        f"[cyan]d1[green] delete w1 [white]{g.w1.lemma_1}[/white] antonym [white]{g.w1.antonym}"
    )
    if g.w2:
        print(
            f"[cyan]a [green] auto-update w2 [white]{g.w2.lemma_1}[/white] antonym [white]{g.w2.antonym}"
        )
        print(
            f"[cyan]r [green] replace [white]{g.w2.lemma_1}[/white] antonym [white]{g.w2.antonym}"
        )
        print(
            f"[cyan]m [green] manual update w2 [white]{g.w2.lemma_1}[/white] antonym [white]{g.w2.antonym}"
        )
        print(
            f"[cyan]d2[green] delete w2 [white]{g.w2.lemma_1}[/white] antonym [white]{g.w2.antonym}"
        )
    ...
    if g.w2:
        if route == "a":
            ...
            if new_antonym:
                ...
                g.db_session.commit()
                print(
                    f"{g.w2.lemma_1} [green]antonym udpated with [white]{g.w2.antonym}"
                )
