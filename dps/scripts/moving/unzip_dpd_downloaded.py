...
gd_dir = os.path.join(software_dir, "Golden Dictionary", "Default")

md_dir = os.path.join(software_dir, "MDict", "dpd")
...
if os.path.exists(dpd_goldendict_src):
    ...
    # Print completion message in green color
    print(
        "\033[1;32m dpd_goldendict.zip has been unpacked to the server folder \033[0m"
    )
else:
    print(
        "\033[1;31m dpd_goldendict.zip is missing. Cannot proceed with moving. \033[0m"
    )
