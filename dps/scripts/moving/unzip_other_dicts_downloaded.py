...
md_dir = os.path.join(software_dir, "MDict", "various pali&sk")
...
for file in other_dicts_gd_files:
    ...
    if os.path.exists(file_path):
        ...
        print(
            f"\033[1;32m {file} has been unpacked to the local GoldenDict folder \033[0m"
        )
        os.remove(file_path)
