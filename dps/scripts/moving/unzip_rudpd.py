...
# Assuming the script is in the 'Documents/dpd-db/dps/scripts/moving' directory
...
gd_dir = os.path.join(software_dir, "Golden Dictionary", "Optional")

md_dir = os.path.join(software_dir, "MDict", "ru-dpd")

share_dir = os.path.join(deva_dir, "Documents", "dpd-db", "exporter", "share")

kd_dir = os.path.join(software_dir, "Ebook Readers Dictionary")
...
if os.path.exists(dpd_kindle_mobi_src):
    ...
    print(
        "\033[1;31m ru_dpd_kindle.mobi is missing. Cannot proceed with moving. \033[0m"
    )
...
if os.path.exists(dpd_kindle_epub_src):
    ...
    print(
        "\033[1;31m ru_dpd_kindle.epub is missing. Cannot proceed with moving. \033[0m"
    )
