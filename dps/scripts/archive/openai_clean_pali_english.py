...
def main():
    ...
    with open(
        "resources/other_pali_texts/anandajoti_safeguard_recitals_pali_only.txt",
        "w",
        encoding="utf-8",
    ) as output_file:
...
def call_openai(messages):
    return openai.ChatCompletion.create(model="gpt-3.5-turbo-0125", messages=messages)
