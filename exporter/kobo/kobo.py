...
def compile_dict_data(g: GlobalData):
    ...
    for count, i in enumerate(db):
        html = g.dpd_template.render(i=i, css=g.css)
...
def main():
    ...
    export_to_kobo_with_pyglossary(dict_info, dict_vars, g.dict_data)

    export_to_goldendict_with_pyglossary(dict_info, dict_var_gd, g.dict_data)
