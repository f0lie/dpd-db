...
def show_all_fields(values, window, flags, username, hide_list_all):
...
def show_root_fields(values, window, hide_list_all, username, flags):
...
def show_compound_fields(values, window, hide_list_all, username, flags):
