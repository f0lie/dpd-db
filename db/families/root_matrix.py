...
def generate_root_matrix(db_session):
    ...
    for counter, i in enumerate(dpd_db):
        ...
        if i.root_key:
            ...
            if i.pos == "pr":
                # first caus & pass
                if re.findall(r"\bcaus\b", i.root_base) and re.findall(
                    r"\bpass\b", i.root_base
                ):
                    root_matrix[i.root_key]["verbs"]["pr caus & pass"] += [headword]
                    word_counter += 1

                # desid & caus
                elif re.findall(r"\bcaus\b", i.root_base) and re.findall(
                    r"\bdesid\b", i.root_base
                ):
                ...
                if re.findall(r"\bcaus\b", i.root_base) and re.findall(
                    ...
                    root_matrix[i.root_key]["participles"]["prp caus & pass"] += [
                        headword
                    ]
                    word_counter += 1

                # desid and pass
                elif re.findall(r"\bdesid\b", i.root_base) and re.findall(
                    r"\bpass\b", i.root_base
                ):
                    root_matrix[i.root_key]["participles"]["prp desid & pass"] += [
                        headword
                    ]
                    word_counter += 1
                ...
                # deno & caus
                    ...
                    root_matrix[i.root_key]["participles"]["prp deno & caus"] += [
                        headword
                    ]
                    word_counter += 1
                ...
                if re.findall(r"\bcaus\b", i.root_base) and re.findall(
                    ...
                    root_matrix[i.root_key]["participles"]["pp caus & pass"] += [
                        headword
                    ]
                    word_counter += 1
                ...
                # deno & caus
                    ...
                    root_matrix[i.root_key]["participles"]["pp deno & caus"] += [
                        headword
                    ]
                    word_counter += 1
            ...
            # app
                ...
                if re.findall(r"\bcaus\b", i.root_base) and re.findall(
                    ...
                    root_matrix[i.root_key]["participles"]["ptp caus & pass"] += [
                        headword
                    ]
                    word_counter += 1
                ...
                # deno & caus
                    ...
                    root_matrix[i.root_key]["participles"]["ptp deno & caus"] += [
                        headword
                    ]
                    word_counter += 1
            ...
            # special case
                ...
                if re.findall(r"\bcaus\b", i.root_base) and re.findall(
                    ...
                    root_matrix[i.root_key]["adjectives"]["adj caus & pass"] += [
                        headword
                    ]
                    word_counter += 1
                ...
                # deno & caus
                    ...
                    root_matrix[i.root_key]["adjectives"]["adj deno & caus"] += [
                        headword
                    ]
                    word_counter += 1
    ...
    for counter, i in enumerate(roots_db):
        try:
            ...
            print(
                f"[bright_red]!!! ERROR: {i.root} [red]does not exist, consider deleting it.",
                end=" ",
            )
            i.root_matrix = ""
