...
def definition_to_dict(
    file_name, ref_code, nikaya, book, title, subhead, bold, bold_end, commentary
) -> Dict[str, str]:
    dict = {
        "file_name": file_name,
        "ref_code": ref_code,
...
def bold_p_trimmer(text):
    ...
    while i > 0:
        ...
        elif is_fullstop is True and is_bold is True and is_bracket is False:
